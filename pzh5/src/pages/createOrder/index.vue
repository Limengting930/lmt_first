<template>
  <div class="container">
      ...
      <van-cell class="flex-box">
          <template #title>接送地址</template>
          <template #default>
            <van-field class="text" input-align="right"
...
const showTimeConfirm = async(item) => {
